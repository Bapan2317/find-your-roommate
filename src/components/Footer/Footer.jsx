    ...
    return (
        <div className="bg-base-300">
            <div className=" max-w-10/12 mx-auto py-12 border-b">
                <div className='bg-primary flex justify-between p-8 rounded-2xl'>
                ...
                <div className="flex justify-between mt-12">
                    ...
                    <div className="">
                        ...
                        <nav className="space-x-6 text-xs font-medium hidden md:flex flex-col space-y-4 *:flex *:items-center *:gap-1">
