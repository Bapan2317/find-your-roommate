    ...
    return (
        <div className='bg-gray-700 w-full py-6 px-12 rounded-2xl  transition-transform hover:scale-105 hover:shadow-xl'>
            ...
            <Link to={`/roommate/${_id}`}>
                <button className='text-secondary py-1 cursor-pointer rounded mt-4 w-full text-xs font-bold mx-auto block bg-primary '>Read more</button>
            </Link>
        </div>
    );
};

export default BrowseListingDetails;